package ua.com.kneu.group203.example3.calculation;
...
//                }));
        ...
        Stream.of(b1, b5, b6, b7, b9, b10, b11, b13, b14, b15)
                .forEach(ee ->
                        ee.addActionListener(eee ->
                                display.setText(display.getText() + ee.getText())));


        Stream.of(b1, b5, b6, b7, b9, b10, b11, b13, b14, b15, display).forEach(ee->
            ee.setFont(new Font("Arial", Font.BOLD, 30))
        );

//        b16.addActionListener(new AbstractAction() {
//            @Override
//            public void actionPerformed(ActionEvent e) {
...
//        });
        ...
        Stream.of(b16, b12, b8, b4).forEach(ee -> {
            ee.addActionListener(eee -> {
                first = Double.parseDouble(display.getText());
